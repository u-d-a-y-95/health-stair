    ...
    <SafeScreen>
      ...
      >
        <View style={{ justifyContent: "center" }}>
          <UText size="sm">
            গর্ভাবস্থা (যা গর্ভধারণ বা জেস্টেশন নামেও পরিচিত) হলো সেই সময়কাল যখন
            একজন নারীর শরীরে এক বা একাধিক ভ্রূণ বৃদ্ধি পায়। গর্ভধারণের পূর্বে
            প্রয়োজনীয় সেবা/পরামর্শের মাধ্যমে একজন নারী অনাকাঙ্খিত গর্ভাবস্থা
            রোধসহ গর্ভকালীন জটিলতা এড়িয়ে যেতে পারেন।
          </UText>
          ...
          <UText size="sm" align="justify" styles={{ marginTop: hs(10) }}>
            ...
            গর্ভাবস্থা পরীক্ষা করতে হবে। আপনার শেষ মাসিকের শুরু হওয়ার তারিখ
            নির্ণয় করুন। যদি আপনার মাসিক অনিয়মিত হয়, তাহলে এই গর্ভাবস্থা
            নির্ধারক ক্যালকুলেটরটি সঠিকভাবে কাজ নাও করতে পারে। এই ক্ষেত্রে
            স্বাস্থ্যকেন্দ্রে গিয়ে আল্ট্রাসাউন্ড (সোনোগ্রাম) বা গর্ভাবস্থা
            পরীক্ষা করতে হবে। যদি আপনার তারিখ মনে না থাকে, তাহলে নিম্নে উল্লেখিত
            পরামর্শ গুলো দেখুন।
          </UText>
          <View
            style={{
